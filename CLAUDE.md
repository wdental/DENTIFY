...
- **Pendiente — Fase 4B**: pagos, abonos y caja.
...
La base de datos (`db/schema.sql`) ya incluye tablas mínimas preparadas para la Fase 4B (`presupuestos`, `pagos`) y para la Fase 5 (`firmas` genérica, ya en uso por evoluciones) para no requerir migraciones destructivas más adelante. Ver especificación completa de la Fase 4A en `docs/fase-4a.md`.
